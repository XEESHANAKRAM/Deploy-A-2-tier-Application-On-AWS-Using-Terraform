...
#all avalablility zones in region
data "aws_availability_zones" "avalablility_zones" {}

#create Subnet pub_sub_1a
...
# associate public subnet to pub-sub-1a, public route table
